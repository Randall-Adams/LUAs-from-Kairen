    ...
    New = (function(_filePath)
        ...
        function self.Interact(_interaction)
            ...
            --elseif _interaction == "StartDialogue" then
                ...
                --elseif self.Name() == "Guard Perinen" then
                --    self.Speak("Feck off!!", "PopupBox")
                --else
                --    self.Speak("Hail " .. AddressList["PlayerName"].Value(), "PopupBox")
                --end
            --end
            print("001| trying " .. _interaction .. " with " .. self.Name())
            if _interaction == "DeltaDialogue" then
                if Dialogue ~= nil then
                    print("002| trying " .. _interaction .. " with " .. self.Name())
                    Dialogue.Try(self.Name())
                end
            end
        end
